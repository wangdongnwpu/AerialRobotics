function [xtraj, ttraj, terminate_cond] = test_trajectory(start, stop, map, path, vis, decomp)
...
disp(['Trajectory tracking  time is :', num2str(time), ' seconds.']);
